    ...
    return (
        <div>
            ...
            <Box p={10} bg={"#fff2cc"} textAlign={"center"} mt={0}>
                <Text fontSize={36}><b>Read Hundreds of Reviews</b></Text>
                <Image mt={5} ml={"40%"} src='https://tmetric.com/media/rt1k0zjc/img-rating-4-5.svg'></Image>
                <Text mt={5} fontSize={36}><b>4.5 Customer Rating</b></Text>
                <Text mt={5} color={"blue"} fontSize={36}><b>242 Reviews</b></Text>
            </Box>


            <Box p={10} bg={"#f6f7f8"} textAlign={"center"} mt={0}>
                <Text><b>Used and trusted by 3000+ businesses in the world</b></Text>
            ...
            <Box p={10} bg={"#41338f"} textAlign={"center"} mt={0}>
                <Text fontSize={48} color={"white"}><b>Make time work for you!</b></Text>
                <Button mt={10} p={7} w={190} fontSize={18} bg={"white"} color='black' borderRadius={5} border={"1px solid grey"}>Start Free Trial</Button>

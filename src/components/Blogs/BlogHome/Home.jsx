  ...
  return (
    <div style={{ border: "1px solid blue" }}>
      ...
      >
        ...
        <Box height={"300"} border={"2px solid blue"}>
          <Stack direction="row">
            <Image
              boxSize="200px"
              src="https://tmetric.com/#_ga=2.220323480.1015807249.1664256999-1861978078.1664256999"
            />
          </Stack>
          <Stack direction="row">
        ...
        <Box border={"2px solid red"}>
          <Grid h="1000px" templateRows="repeat(7, 1fr)" templateColumns="repeat(3, 1fr)" gap={4}>

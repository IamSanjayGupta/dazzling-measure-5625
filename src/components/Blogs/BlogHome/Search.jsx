...
function Search() {
  ...
  return (
    <div>
      <BlogSearchNav />
      <Box textAlign={"center"} padding={"0rem 2.5rem 4rem 2.5rem"} marginTop={"140px"}>
        <Box h={"auto"} w={"90%"} margin={"auto"} textAlign={"center"}>
          <Box padding={"2rem 2.5rem 2rem 2.5rem"}>
            <Heading fontSize={55} fontWeight={"bold"}>
              Search TMetric Blog - Time Tracking Tips and Productivity Hacks
            </Heading>
          </Box>
          <Box>
            <Box
